...
$edit_id = $result['id'];
$edit_region = $result['region'];
$edit_time = $result['time'];
                    ...
                    <div class="post_forms">
                        <!-- 地域選択 -->
                            <div class="form">
                                <p><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-map" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg> 地域<span style="color:red ; font-size:x-small">(※選択してください)</span>
                                </p>
                        ...
                        <div class="form">
                            <p><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calendar3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input class="form-control" type="text"  name="time" value="<?php echo $edit_time ?>" maxlength="15" placeholder="例）2020年頃" autofocus required></input>
                        </div>
                        <!-- 内容 -->
                        <div class="form">
                            <p><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-text-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <textarea class="form-control" type="text" name="content" rows="9" maxlength="300" value="" autofocus required><?php echo $edit_content ?></textarea>                            
                        </div>
